  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
        ...
        {tab === "karya" ? (
          ...
          <form onSubmit={handleProfileSubmit} className="p-6 border-3 border-ink rounded-3xl bg-papersoft shadow-hard max-w-xl">
            ...
            <div className="mb-4 mt-2">
              <label className="block font-mono text-[11px] font-bold text-ink/60 mb-2">Tema Warna Website</label>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {THEME_OPTIONS.map((t) => (
                  <button
                    ...
                    className={`text-left px-4 py-3 rounded-xl border-2.5 flex items-center gap-3 ${
                      profile.theme === t.id ? "border-pink bg-pink/10" : "border-ink/20"
                    }`}
                  >
                    <span data-theme={t.id} className="flex gap-1 flex-shrink-0">
                      <span className="w-3.5 h-3.5 rounded-full bg-pink inline-block" />
                      <span className="w-3.5 h-3.5 rounded-full bg-blue inline-block" />
                      <span className="w-3.5 h-3.5 rounded-full bg-yellow inline-block" />
                    </span>
      ...
      <style jsx global>{`
        .input {
          width: 100%;
          background: rgb(var(--c-papersoft));
          border: 2.5px solid rgb(var(--c-ink));
          border-radius: 12px;
          padding: 10px 14px;
          font-size: 14px;
          color: rgb(var(--c-ink));
